# py ./eventscanner.py http://83.149.167.172:8545
...
if __name__ == "__main__":
    ...
    # thenftmagaz.eth smart contract
    #RCC_ADDRESS = "0x6Da705478b5C1FD9Cac9E664015c0dB98Bd1A3A0"

    # OpenSea  ERC-1155 smart contract 
    #RCC_ADDRESS = "0x495f947276749Ce646f68AC8c248420045cb7b5e"

    # BOTTO ERC-20 smart contract 
    RCC_ADDRESS = "0x9DFAD1b7102D46b1b197b90095B5c4E9f5845BBA"
    ...
    class JSONifiedState(EventScannerState):
        ...
        def __init__(self):
            self.state = None
            self.fname = "bott-erc20-events.json"
